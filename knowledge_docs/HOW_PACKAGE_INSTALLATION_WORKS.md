...
**Exception:** AI-GCE (Governance & Compliance Engine) and AI-TGE (Test Governance Engine) run alongside AI-DLC (AI-Driven Development Life Cycle — Amazon's open-source build lifecycle) (concurrent, not sequential). Their rules coexist with whatever build workflow is active.
...
|---------|-----------|:------------:|:---------:|
| AI-ILC (Idea Life Cycle) | `core-workflow.md` | 12 files | 6 templates |
| AI-PILC (Project Initiation Life Cycle) | `core-workflow.md` | 18 files | 14 templates |
| AI-ADLC (Architecture Design Life Cycle) | `core-workflow.md` | 25+ files | 13 templates |
| AI-DWG (Workspace Generator) | `core-generator.md` | 30+ files | 48 templates |
| AI-GCE | `core-engine.md` | 20+ files | 12 templates |
| AI-TGE | `core-engine.md` | 18 files | 6 templates |
| AI-POLC (Product Ownership Life Cycle) | `core-workflow.md` | 15+ files | 10 templates |
| AI-UXD (UX Design) | `core-workflow.md` | 15+ files | 10 templates |
