...
2. **No conflicts by design:** Each extension adds rules in its own namespace (EVS-*, DDD-*, MICRO-*, BFF-*, ES-*, RES-*, FF-*). No rule from one extension contradicts another.
...
| All 7 extensions active on a small project | Overwhelming constraint set; most rules won't apply | Match extensions to actual complexity — most projects need 0-2 |
