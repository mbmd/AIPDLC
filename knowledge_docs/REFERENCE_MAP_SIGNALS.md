...
|---|------|----|----|--------|------|
| 1 | AI-ADLC (Architecture Design Life Cycle) | AI-DWG (Workspace Generator) | `architecture-revised` | Changed AP artifact(s) | Reconcile workspace (Mode 2) |
...
| 6 | AI-ADLC | AI-TGE (Test Governance Engine) | `architecture-revised` | Changed AP artifact(s) | Update test register (Stage 10) |
| 7 | AI-DWG | AI-GCE (Governance & Compliance Engine) | `steering-files-updated` | List of changed `.kiro/steering/` files | Re-derive rules for affected files |
...
| 11 | AI-POLC (Product Ownership Life Cycle) | AI-DWG | `backlog-updated` | Changed PBP artifacts | Refresh workspace enrichment (DoR/DoD) |
| 12 | AI-UXD (UX Design) | AI-POLC | `personas-updated` | Changed UXP personas/journeys | Refresh backlog prioritization context |
| 13 | AI-DLC (AI-Driven Development Life Cycle — Amazon's open-source build lifecycle) | AI-UXD | `feedback-received` | Runtime usability feedback | Feed into next UX iteration |
| 14 | AI-DLC | AI-POLC | `story-feedback` | Implementation complexity discovery | Feed into backlog refinement |
...
|------|----|--------------|------------------|
| AI-ILC (Idea Life Cycle) | AI-PILC (Project Initiation Life Cycle) | Idea Brief | One-time handoff; ILC doesn't update after routing |
