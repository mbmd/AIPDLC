...
# AIPDLC — The AI-* PDLC (Product Development Life Cycle) Family

> Injectable workflow packages that give AI coding agents structured expertise for professional software delivery.

## What This Skill Provides

When installed, your AI agent gains access to **11 chained workflow packages** covering the full PDLC (Product Development Life Cycle) — from raw idea to production-ready workspace with governance and test accountability baked in.
...
|---------|-------------|-------------|
| **AI-ILC** (Idea Life Cycle) | Raw idea → Approved Idea Brief | Product Manager |
| **AI-PILC** (Project Initiation Life Cycle) | Requirement → Project Initiation Package | PMO Advisor |
| **AI-PPM** (Project Portfolio Management) | Multiple PIPs → Portfolio governance | Portfolio Manager |
| **AI-FLO** (Flow Orchestrator) | Package-to-package routing | Orchestration Engine |
| **AI-POLC** (Product Ownership Life Cycle) | PIP → Product Backlog Package | Product Owner |
| **AI-UXD** (UX Design) | PIP + PBP → UX Design Package | UX Designer |
| **AI-ADLC** (Architecture Design Life Cycle) | Requirements → Architecture Package | CTO / Architect |
| **AI-DWG** (Workspace Generator) | AP + PBP + UXP → Ready-to-code workspace | DevOps Engineer |
| **AI-GCE** (Governance & Compliance Engine) | Workspace → Compliance enforcement | Governance Officer |
| **AI-TGE** (Test Governance Engine) | Workspace → Test strategy & coverage | QA Lead |
